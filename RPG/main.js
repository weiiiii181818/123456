var mapArry, ctx, currentImgMainX, currentImgMainY;
var imgMountain, imgMain, imgEnemy;
$(document).ready(function(){
    mapArry = [0,1,1,0,0,0,3,1,2];
...
$(document).keydown(function(event){
    ...
    if(targetBlock==-1 || mapArry[targetBlock]==1 || mapArry[targetBlock]==3)
    {
